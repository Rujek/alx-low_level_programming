 ...
 * @e_ident: a pointer to an array containingthe ELF version
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI:	");
 ...
 * @e_ident: a pointer to an arrat containing the ELF ABI verion
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_entry - prints the entry pointof an ELF header
